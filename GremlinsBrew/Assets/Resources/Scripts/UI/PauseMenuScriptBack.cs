...
public class PauseMenuScriptBack : MonoBehaviour
{
    //Pause Menu States
    ...
    public int OptionbuttonSelected = 0, OptionsListMax = 2;
    public Sprite selected, UnSelected, ControllerSelected, ControllerUnSelected;
    public GameObject[] BrightnessIcon = new GameObject[3];
    ...
    void Start()
    {
        ...
        for (int i = 0; i < BrightnessIcon.Length;i++)
        {
            Color c = BrightnessIcon[i].GetComponent<Image>().color;
            c.a = 0.33f*(i+1);
            BrightnessIcon[i].GetComponent<Image>().color = c;
        }
    }
        ...
        else
        {
            ...
            if (InputManager.Devices.Count > 0)
            {
                for (int i = 0; i < InputManager.Devices.Count; i++)
                {
                    ...
                    {
                        UnhighlightButtons();
                        OptionbuttonSelected = (OptionbuttonSelected < OptionsListMax) ? (OptionbuttonSelected + 1) : 0;
                        FirstJoystickMove[i] = false;
                        JoyStickMenuDelay[i] = 0;
                        ResetMenuStick(i);
                    ...
                    else if (Input.GetKeyDown("w") || (InputManager.Devices[i].DPadUp.WasPressed) || (y[i] >= 0.5 && (JoyStickMenuDelay[i] >= MenuDelayMax[i] || FirstJoystickMove[i] == true)))
                    {
                        ...
                        FirstJoystickMove[i] = false;
                        JoyStickMenuDelay[i] = 0;
                        OptionbuttonSelected = (OptionbuttonSelected > 0) ? (OptionbuttonSelected - 1) : (OptionsListMax);
    ...
    private void UpdateOptionHorizontal(bool Left)
    {
        ...
        {
            case 0: // BrightnessSlider
                {
                    if (Left)
                    {
                        BrightnessVal.value -=0.1f;
                    }
                    else
                    {
                        BrightnessVal.value += 0.1f;
            ...
            case 2: // Player 1 UI Buttons Slider
                {
                    ChangeUIGFX(0);
                    UpdateControlUI();
                    break;
                }
            //case 3: // Player 2 UI Buttons Slider
            //    {
            //        ChangeUIGFX(1);
            //        break;
            //    }
            ...
            case 2:
                {
                    ...
                    OptionSelection[2].ArrowL.GetComponent<Image>().sprite = selected;
                    OptionSelection[2].ArrowR.GetComponent<Image>().sprite = selected;
                    break;
                }
            case 3:
                {
                    ...
                    OptionSelection[3].ArrowL.GetComponent<Image>().sprite = selected;
                    OptionSelection[3].ArrowR.GetComponent<Image>().sprite = selected;
                    break;
                }
        }
    }
    ...
    public void ChangeUIGFX(int i)
    {
        if (GameControllerScript.PSController[i] == 0)
        {
            ...
            ControllerSelectUI[i + 3].ArrowL.GetComponent<Image>().sprite = ControllerUnSelected;
            ControllerSelectUI[i + 3].ArrowR.GetComponent<Image>().sprite = ControllerSelected;
        }
        else
        {
            GameControllerScript.PSController[i] = 0;
            ControllerSelectUI[i + 3].ArrowL.GetComponent<Image>().sprite = ControllerSelected;
            ControllerSelectUI[i + 3].ArrowR.GetComponent<Image>().sprite = ControllerUnSelected;
